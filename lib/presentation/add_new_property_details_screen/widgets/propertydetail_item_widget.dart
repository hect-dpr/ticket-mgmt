...
import '../models/propertydetail_item_model.dart';
...
class PropertydetailItemWidget extends StatelessWidget {
  PropertydetailItemWidget(this.propertydetailItemModelObj);

  PropertydetailItemModel propertydetailItemModelObj;
